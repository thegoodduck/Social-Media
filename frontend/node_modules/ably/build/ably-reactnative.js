...
class BaseRealtime extends baseclient_1.default {
    ...
    constructor(options) {
        ...
        this._objectsPlugin = (_d = (_c = this.options.plugins) === null || _c === void 0 ? void 0 : _c.Objects) !== null && _d !== void 0 ? _d : null;
...
class RealtimeChannel extends eventemitter_1.default {
    ...
    constructor(client, name, options) {
        ...
        if ((_c = client.options.plugins) === null || _c === void 0 ? void 0 : _c.Objects) {
    ...
    async processMessage(message) {
        ...
        switch (message.action) {
            ...
            case protocolmessagecommon_1.actions.OBJECT_SYNC: {
                ...
                await Promise.all(objectMessages.map((om) => this.client._objectsPlugin.ObjectMessage.decode(om, this.client, this.logger, logger_1.default, Utils, format)));
...
class RestAnnotations {
    ...
    async get(msgOrSerial, params) {
        const client = this.channel.client, messageSerial = serialFromMsgOrSerial(msgOrSerial), format = client.options.useBinaryProtocol ? Utils.Format.msgpack : Utils.Format.json, envelope = client.http.supportsLinkHeaders ? undefined : format, headers = defaults_1.default.defaultGetHeaders(client.options, { format });
        Utils.mixin(headers, client.options.headers);
        ...
        try {
            ...
            if (items && items.length)
                for (let i = 0; i < items.length; i++)
                    this.onProtocolMessage((0, protocolmessage_1.fromDeserialized)(items[i], this.connectionManager.realtime._RealtimePresence, this.connectionManager.realtime._Annotations, this.connectionManager.realtime._objectsPlugin));
        }
        catch (e) {
    ...
    send(msg, queueEvent, callback) {
        ...
        if (this.logger.shouldLog(logger_1.default.LOG_MICRO)) {
            logger_1.default.logAction(this.logger, logger_1.default.LOG_MICRO, 'ConnectionManager.send()', 'queueing msg; ' +
                (0, protocolmessage_1.stringify)(msg, this.realtime._RealtimePresence, this.realtime._Annotations, this.realtime._objectsPlugin));
        }
    ...
    send(pendingMessage) {
        ...
        if (this.logger.shouldLog(logger_1.default.LOG_MICRO)) {
            logger_1.default.logActionNoStrip(this.logger, logger_1.default.LOG_MICRO, 'Protocol.send()', 'sending msg; ' +
                (0, protocolmessage_1.stringify)(pendingMessage.message, this.transport.connectionManager.realtime._RealtimePresence, this.transport.connectionManager.realtime._Annotations, this.transport.connectionManager.realtime._objectsPlugin));
        }
    ...
    onProtocolMessage(message) {
        if (this.logger.shouldLog(logger_1.default.LOG_MICRO)) {
            logger_1.default.logActionNoStrip(this.logger, logger_1.default.LOG_MICRO, 'Transport.onProtocolMessage()', 'received on ' +
                this.shortName +
                ': ' +
                (0, protocolmessage_1.stringify)(message, this.connectionManager.realtime._RealtimePresence, this.connectionManager.realtime._Annotations, this.connectionManager.realtime._objectsPlugin) +
                '; connectionId = ' +
...
class WebSocketTransport extends transport_1.default {
    ...
    onWsData(data) {
        ...
        try {
            this.onProtocolMessage((0, protocolmessage_1.deserialize)(data, this.connectionManager.realtime._MsgPack, this.connectionManager.realtime._RealtimePresence, this.connectionManager.realtime._Annotations, this.connectionManager.realtime._objectsPlugin, this.format));
        }
        catch (e) {
...
async function encode(msg, options) {
    ...
    const isNativeDataType = typeof msg.data == 'string' ||
        platform_1.default.BufferUtils.isBuffer(msg.data) ||
        msg.data === null ||
        msg.data === undefined;
...
function fromDeserialized(deserialized, presenceMessagePlugin, annotationsPlugin, objectsPlugin) {
    ...
    if (objectsPlugin && deserialized.state) {
        state = objectsPlugin.ObjectMessage.fromValuesArray(deserialized.state, Utils, basemessage_1.MessageEncoding);
    }
...
function makeFromDeserializedWithDependencies(dependencies) {
    return (deserialized) => {
        ...
        return fromDeserialized(deserialized, {
            PresenceMessage: presencemessage_1.default,
            WirePresenceMessage: presencemessage_1.WirePresenceMessage,
        }, { Annotation: annotation_1.default, WireAnnotation: annotation_1.WireAnnotation, RealtimeAnnotations: realtimeannotations_1.default, RestAnnotations: restannotations_1.default }, (_a = dependencies === null || dependencies === void 0 ? void 0 : dependencies.ObjectsPlugin) !== null && _a !== void 0 ? _a : null);
    };
}
...
function stringify(msg, presenceMessagePlugin, annotationsPlugin, objectsPlugin) {
    ...
    if (msg.state && objectsPlugin) {
        result +=
            '; state=' + toStringArray(objectsPlugin.ObjectMessage.fromValuesArray(msg.state, Utils, basemessage_1.MessageEncoding));
    }
    if (msg.error)
