...
function localDeviceFactory(deviceDetails) {
  return class LocalDevice extends deviceDetails {
    ...
    async listSubscriptions() {
      ...
      const client = this.rest, format = client.options.useBinaryProtocol ? client.Utils.Format.msgpack : client.Utils.Format.json, envelope = client.http.supportsLinkHeaders ? void 0 : format, headers = client.Defaults.defaultGetHeaders(client.options, { format });
